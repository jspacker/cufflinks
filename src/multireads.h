...
public:
	...
	//nimrod: get_mass(const MateHit& hit) is insensitive to allele info and will return the combined parental mass
	//get_mass(const MateHit& hit, double& paternal_mass, double& maternal_mass) is allele sensitive and will return eah parental mass separately
